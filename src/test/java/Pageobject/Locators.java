...
//Personal Information
	...
	public void Maritalstatus() throws Exception{
			...
			new Select(driver.findElement(residence)).selectByVisibleText("BostadsrÃ¤tt");
...
// Employment
	 ...
	 public void EmploymentInfo() throws InterruptedException
	 
	  {
		...
		{
		new Select(driver.findElement(employment)).selectByVisibleText("Fast anstÃ¤lld");
		Thread.sleep(5000);
		...
		{
			new Select(driver.findElement(employment)).selectByVisibleText("ProjektanstÃ¤lld");
		...
		if(i==4) {	
			...
			new Select(driver.findElement(coemployment)).selectByVisibleText("Fast anstÃ¤lld");
		...
		for (int i=0;i<=1;i++)
	 {
		 ...
		 new Select(driver.findElement(loanpurpose)).selectByVisibleText("KÃ¶rkort");
